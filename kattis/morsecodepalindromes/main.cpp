...
string m[36] {"12","2111","2121","211","1","1121","221","1111","11","1222","212","1211","22","21","222","1221","2212","121","111","2","112","1112","122","2112","2122","2211","22222","12222","11222","11122","11112","11111","21111","22111","22211","22221"},s,t="";

void solve() {
	for(auto c: s) {
		c=tolower(c);
		if('a'<=c&&c<='z') t+=m[c-'a'];
		else if('0'<=c&&c<='9') t+=m[c-'0'+26];
	}
